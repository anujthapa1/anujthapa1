...
**BSc (Hons) Computing Student | Aspiring Software Developer**

I am a computing student based in Pokhara, Nepal, focused on software development, web technologies, and cybersecurity. I build practical applications, write clean code, and actively expand my skills across core computer science and digital technologies.

---

## 👨‍💻 About Me

- 🎓 Currently pursuing a **BSc (Hons) in Computing** at **Informatics College Pokhara**.
- 💡 Deeply interested in **Software Development**, **Full-Stack Web Development**, and **Cybersecurity**.
- 🌐 Broadening my knowledge in **Digital Technology**, including **SEO and Digital Marketing**.
- 🛠️ Enthusiastic about building functional tools, solving practical problems, and collaborating on open-source projects.

---

## 🎯 Current Focus

- 🐍 Mastering advanced **Python** concepts and standard software design patterns.
- ☕ Strengthening core Object-Oriented Programming (OOP) in **Java**.
- ⚛️ Building responsive, interactive user interfaces with **React** and modern **JavaScript**.
- 🔒 Learning foundational principles of **Cybersecurity** and secure coding practices.
- 📈 Exploring **SEO and Digital Marketing** tactics for web platforms.
...
![Digital Marketing](https://img.shields.io/badge/Digital_Marketing-FF6F00?style=for-the-badge)
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-00599C?style=for-the-badge)
...
- **SEO & Digital Marketing:** Integrating performance optimization, metadata structure, and web metrics into development workflows.
...
<div align="center">
  <sub>Building software with purpose. Focused on continuous technical growth and clean code.</sub>
</div>
